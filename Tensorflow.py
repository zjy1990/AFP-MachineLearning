...
train_data = raw_data
test_data = pd.read_csv('data/vitual_trading_test.csv',sep = ',')
#tech firm
...
def getTestingBatch_virtual(batch_size, testdata):
...
#run model random time series
    ...
    for step in range(test_data.shape[0] - num_of_time_series + 1):
        ...
        nextTestBatch= getTestingBatch_virtual(batch_size, test_data.iloc[step : step + num_of_time_series , :])
